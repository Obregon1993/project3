        ...
        return (
            <div className="App">
                ...
                <div id="index-banner" className="parallax-container">
                    ...
                    <div className="parallax"><img src="./client/public/images/background1.jpg" alt="Unsplashed background img 1"></img></div>
                </div>
                ...
                <div className="parallax-container valign-wrapper">
                    ...
                    <div className="parallax"><img src="./public/images/background2.jpg" alt="Unsplashed background img 2"></img></div>
                </div>
                ...
                <div className="parallax-container valign-wrapper">
                    ...
                    <div className="parallax"><img src="../public/images/background3.jpg" alt="Unsplashed background img 3"></img></div>
                </div>
